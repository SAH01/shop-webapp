...
INSERT INTO `goods` VALUES ('x043', '/static/img/goods/sports-8.jpg', '健身', '健康生活', 'Keep跑步机', '1999', '60', '小型超静音走步机', '运动', '11');
...
-- ----------------------------
INSERT INTO `goodslist` VALUES ('x020', '/static/img/goods/book-4.jpg', '小粽子小粽子绘本', '27');
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('xxx2018620013', 'test2', 'x002,x010,x015', '宽松休闲裤韩版潮流运动裤,德芙巧克力3碗装,青岛双星正品标准球', '278');
INSERT INTO `orders` VALUES ('xxx2018620014', 'test2', 'x010', '德芙巧克力3碗装', '96');
INSERT INTO `orders` VALUES ('xxx2018621002', 'test1', 'x005,x007,x010', '智能手机苹果X 10,Apple/苹果 Ipad,德芙巧克力3碗装', '9816');
INSERT INTO `orders` VALUES ('xxx2022510001', 'test1', 'x020', '小粽子小粽子绘本', '27');
...
-- Records of sort
-- ----------------------------
INSERT INTO `sort` VALUES ('小说', '正版包邮', '/static/img/index/b1.jpg');
INSERT INTO `sort` VALUES ('幼儿', '启蒙教育', '/static/img/index/b4.jpg');
INSERT INTO `sort` VALUES ('科幻', '科幻图书', '/static/img/index/b3.jpg');
INSERT INTO `sort` VALUES ('软件', '工具书籍', '/static/img/index/b2.jpg');
